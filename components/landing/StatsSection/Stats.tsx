...
export default function Stats() {
  return (
    <section className="mx-auto mt-25 md:mt-40 lg:mt-60">
      <div className="flex flex-row items-center justify-center gap-3 sm:gap-4 md:gap-12 lg:gap-24">
    ...
    ${index === stats.length - 1 ? "after:hidden" : "pr-3 sm:pr-4 md:pr-12"}
  `}
          >
            <div className="text-pink-text font-semibold text-[20px] sm:text-[36px] md:text-[48px] xl:text-[86px]">
              {stat.value}
            </div>
