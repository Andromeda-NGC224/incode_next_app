...
import { doSocialEnter, registerUser } from "@/lib/actions";
...
export default function RegisterForm() {
  ...
  const [mainErrorMessage, mainFormAction, isMainPending] = useActionState(
    registerUser,
    undefined
  );
      ...
      <form action={mainFormAction}>
        <div className="flex-1 rounded-lg bg-gray-50 px-6 pt-8">
          ...
          <Button
            ...
            aria-disabled={isMainPending}
            name="registerMainForm"
          >
          ...
          {mainErrorMessage && (
            <div className="flex h-8 items-end space-x-1" aria-live="polite">
              ...
              <p className="text-sm text-red-500">{mainErrorMessage}</p>
            </div>
          )}
